const PrivacyPolicy = () => {
  return (
    <>
      <h2 id="-">Политика в отношении обработки персональных данных</h2>{' '}
      <h3 id="1-">1. Общие положения</h3>{' '}
      <p>
        ...
        данных и меры по обеспечению безопасности персональных данных Nuril
        Baradusov (далее – Оператор). Оператор ставит своей важнейшей целью и
        ...
        тайну. Настоящая политика Оператора в отношении обработки персональных
        данных (далее – Политика) применяется ко всей информации, которую
        Оператор может получить о посетителях веб-сайта{' '}
        <a href="https://russianstreetwear.club">
          https://russianstreetwear.club
        </a>
        .
      </p>{' '}
      <h3 id="2-">2. Основные понятия, используемые в Политике</h3>{' '}
      <p>
        Автоматизированная обработка персональных данных – обработка
        персональных данных с помощью средств вычислительной техники;
        Блокирование персональных данных – временное прекращение обработки
        персональных данных (за исключением случаев, если обработка необходима
        для уточнения персональных данных); Веб-сайт – совокупность графических
        ...
        лиц; Распространение персональных данных – любые действия, направленные
        ...
        персональным данным каким-либо иным способом; Трансграничная передача
        ...
        иностранному физическому или иностранному юридическому лицу; Уничтожение
        персональных данных – любые действия, в результате которых персональные
      ...
      <p>
        Фамилия, имя, отчество; Электронный адрес; Год, месяц, дата и место
        рождения; Фотографии; Сведения об образовании, профессии, специальности
        и квалификации, реквизиты документов об образовании; Cведения о доходах;
        места работы (настоящие и прошлые), места проживания (настоящие и
        прошлые), род деятельности, местонахождение, аккаунты в социальных
        сетях; Также на сайте происходит сбор и обработка обезличенных данных о
      ...
      <h3 id="4-">4. Цели обработки персональных данных</h3>{' '}
      <p>
      ...
      <p>
        ...
        baradusovnh@gmail.com с пометкой «Отказ от уведомлениях о новых
      ...
      <h3 id="5-">5. Правовые основания обработки персональных данных</h3>{' '}
      <p>
      ...
      <p>
        ...
        уведомление на адрес электронной почты Оператора baradusovnh@gmail.com с
        пометкой «Актуализация персональных данных». Срок обработки персональных
        ...
        Оператора baradusovnh@gmail.com с пометкой «Отзыв согласия на обработку
        персональных данных».
      </p>{' '}
      <h3 id="7-">7. Трансграничная передача персональных данных</h3>{' '}
      <p>
      ...
      <p>
        ...
        помощью электронной почты baradusovnh@gmail.com.
      </p>{' '}
      <p>
        ...
        ее новой версией. Актуальная версия Политики в свободном доступе
        расположена в сети Интернет по адресу{' '}
        <a href="https://russianstreetwear.club/docs/privacy_policy/">
          https://russianstreetwear.club/docs/privacy_policy/
        </a>
        .
      </p>
    </>
